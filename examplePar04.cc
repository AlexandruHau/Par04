...
int main(int argc, char** argv)
{
  ...
  // Include the GDML Parser to read the detector geometry
  // from the .gdml file
  G4GDMLParser parser;

  // parser.Read("../Par04_build/myOtherCLIC.gdml");
  parser.Read("../Par04_build/NewCLIC.gdml");

  auto detector = new Par04DetectorConstruction(parser);
